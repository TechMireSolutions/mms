...
**Rules (norms SSOT):** `mms-performance.md` §1 (query discipline, projections, indexes, pagination) · `mms-data-layer.md` §1–§6 (schema, RLS, soft-delete index tiers, autovacuum) · `mms-audit-trail.md` (partitioned tables).
