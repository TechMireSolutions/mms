...
**Rules:** `mms-reports.md`, `mms-data-layer.md` (Query-first policy), `mms-performance.md` §1-2 (Server Aggregates, Streaming & Heavy Exports), `mms-module-architecture.md`, `mms-ui-ux-design.md`, `mms-settings-i18n.md`. Soft-Delete Workflow → **`mms-soft-delete`**.
