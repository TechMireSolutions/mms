...
**Rule (norms SSOT):** `mms-dependencies.md` (version/override policy, banned packages) · `mms-performance.md` (banned client deps) · `mms-backend-security.md` (application-level controls).
