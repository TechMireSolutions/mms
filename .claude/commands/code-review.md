---
description: Review changes against MMS rules and migration status
---

# /code-review — Code Review

Run the MMS **Code Review** workflow end to end.

1. Read `.agent/workflows/code-review.md` and follow it exactly.
