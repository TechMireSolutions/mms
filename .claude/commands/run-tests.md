---
description: Run unit/integration/e2e suites and fix failures
---

# /run-tests — Run Tests

Run the MMS **Run Tests** workflow end to end.

1. Read `.agent/workflows/run-tests.md` and follow it exactly.
