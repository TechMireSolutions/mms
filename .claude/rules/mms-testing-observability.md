...
- Layout/responsiveness regressions: keep `e2e/tests/responsive-shell.spec.ts` and `e2e/tests/responsive-authenticated.spec.ts` green after shell, RTL, touch-target, or toast-layer changes.
