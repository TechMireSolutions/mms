---
description: Configuration hierarchy, persistence, ContactConfigProvider, runtime toggles
paths:
  ...
  - "apps/frontend/src/hooks/useSavedFlash.ts"
  - "apps/frontend/src/lib/settingsPreview.ts"
  - "apps/frontend/src/lib/settingsPreviewStore.ts"
