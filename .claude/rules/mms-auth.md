---
description: Authentication, users shape, session cookies, auth artifacts, tenant session binding
paths:
  - "apps/backend/src/routes/auth.ts"
  - "apps/backend/src/middleware/authenticate.ts"
  - "apps/backend/src/services/authService.ts"
  - "apps/backend/src/services/userService.ts"
  - "apps/backend/src/services/twoFactorService.ts"
  - "apps/backend/src/services/authCookieService.ts"
  - "apps/backend/src/services/authArtifactService.ts"
  - "apps/backend/src/services/authHandoffService.ts"
