---
description: Contact-first person policy — canonical identity in contacts; module rows store link ids only
paths:
  - "apps/frontend/src/lib/db.ts"
  - "apps/frontend/src/lib/contactLink/**"
  - "packages/shared/src/contactLinkPolicy.ts"
  - "packages/shared/src/linkedCollectionUtils.ts"
  - "packages/shared/src/studentUtils.ts"
  - "packages/shared/src/teacherUtils.ts"
  - "apps/frontend/src/components/contactLink/**"
  - "apps/frontend/src/components/ui/RegistryPersonSelect.tsx"
  - "apps/frontend/src/components/ui/UserActorSelect.tsx"
  - "apps/frontend/src/components/students/**"
  - "apps/frontend/src/components/teachers/**"
  - "apps/frontend/src/components/users/**"
  - "apps/frontend/src/components/hasanat/**"
  - "apps/frontend/src/components/finance/**"
  - "apps/frontend/src/components/enrollment/**"
  - "apps/frontend/src/components/attendance/**"
  - "apps/frontend/src/components/examination/**"
  - "apps/backend/src/db/migrations/*normalize*"
  - "apps/backend/src/db/migrations/*contact*"
---
