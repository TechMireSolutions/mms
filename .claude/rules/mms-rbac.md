---
description: Role-based access — backend enforcement, registry permissions, can() hook
paths:
  ...
  - "apps/backend/src/routes/email.ts"
  - "apps/frontend/src/hooks/usePermissions.ts"
  - "apps/frontend/src/hooks/useViewerRole.ts"
  - "packages/shared/src/permissions.ts"
  - "packages/shared/src/userTypes.ts"
