---
description: App translations — en/ar/ur/fa; t() and labelKey; no hardcoded UI copy
paths:
...
| **Contact legacy** | `uiStrings` from `useContactConfig()` | ~24 Contacts files only — **do not add new keys**; migrate to `t('contacts.*')` when touching |
