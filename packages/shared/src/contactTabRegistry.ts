...
export const DEFAULT_COLUMN_REGISTRY: ColumnRegistryEntry[] = [
  ...
  { key: "cnic",                   label: "CNIC / National ID",     labelKey: "contacts.columns.cnic",                   enabled: false, order: 8,  sortable: true,  width: 140 },
  { key: "line1",                  label: "Street Address",         labelKey: "contacts.columns.streetAddress",          enabled: false, order: 9,  sortable: true,  width: 150 },
  ...
  { key: "education_fieldOfStudy", label: "Field of Study",         labelKey: "contacts.columns.educationFieldOfStudy",  enabled: false, order: 17, sortable: false, width: 150 },
  { key: "education_year",         label: "Graduation Year",        labelKey: "contacts.columns.educationYear",          enabled: false, order: 18, sortable: false, width: 130 },
  { key: "education_grade",        label: "Grade / Division",       labelKey: "contacts.columns.educationGrade",         enabled: false, order: 19, sortable: false, width: 130 },
  { key: "experience_title",       label: "Job Title",               labelKey: "contacts.columns.experienceTitle",        enabled: false, order: 20, sortable: false, width: 150 },
  { key: "experience_organization", label: "Organization",           labelKey: "contacts.columns.experienceOrganization", enabled: false, order: 21, sortable: false, width: 160 },
  { key: "experience_employmentType", label: "Employment Type",     labelKey: "contacts.columns.experienceEmploymentType", enabled: false, order: 22, sortable: false, width: 140 },
  { key: "experience_location",    label: "Job Location",           labelKey: "contacts.columns.experienceLocation",     enabled: false, order: 23, sortable: false, width: 140 },
  { key: "skills",                 label: "Skills",                 labelKey: "contacts.columns.skills",                 enabled: false, order: 24, sortable: false, width: 160 },
  { key: "skills_name",            label: "Skill Name",             labelKey: "contacts.columns.skillsName",             enabled: false, order: 25, sortable: false, width: 140 },
  { key: "skills_category",        label: "Skill Category",         labelKey: "contacts.columns.skillsCategory",         enabled: false, order: 26, sortable: false, width: 150 },
  { key: "skills_proficiency",     label: "Skill Proficiency",      labelKey: "contacts.columns.skillsProficiency",      enabled: false, order: 27, sortable: false, width: 140 },
  { key: "skills_yearsOfExperience", label: "Years of Experience",  labelKey: "contacts.columns.skillsYearsOfExperience", enabled: false, order: 28, sortable: false, width: 140 },
  { key: "skills_isCertified",     label: "Certified / Ijazah",     labelKey: "contacts.columns.skillsIsCertified",      enabled: false, order: 29, sortable: false, width: 130 },
  { key: "skills_issuer",          label: "Certifying Body / Issuer", labelKey: "contacts.columns.skillsIssuer",         enabled: false, order: 30, sortable: false, width: 160 },
  { key: "relationship_contact",   label: "Relationship Contact",   labelKey: "contacts.columns.relationshipContact",   enabled: false, order: 31, sortable: false, width: 150 },
  { key: "relationship_type",      label: "Relationship Type",      labelKey: "contacts.columns.relationshipType",      enabled: false, order: 32, sortable: false, width: 140 },
  { key: "notes",                  label: "Notes",                  labelKey: "contacts.columns.notes",                  enabled: false, order: 33, sortable: false, width: 180 },
  { key: "preferredLanguage",      label: "Preferred Language",     labelKey: "contacts.columns.preferredLanguage",      enabled: false, order: 34, sortable: true,  width: 140 },
  { key: "preferredContactMethod", label: "Preferred Contact Method", labelKey: "contacts.columns.preferredContactMethod", enabled: false, order: 35, sortable: true,  width: 160 },
  { key: "doNotContact",           label: "Do Not Contact",         labelKey: "contacts.columns.doNotContact",           enabled: false, order: 36, sortable: true,  width: 120 },
];
