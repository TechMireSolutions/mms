...
export const userContract = c.router({
  list: {
    ...
    responses: { 200: userListPageResponseSchema, 400: errorResponse, 403: errorResponse, 404: errorResponse, 409: errorResponse, 500: errorResponse },
  ...
  bulkUpdate: {
    ...
    responses: { 200: z.object({ users: z.array(workspaceUserRecordSchema) }), 400: errorResponse, 403: errorResponse, 409: errorResponse, 500: errorResponse },
  ...
  bulkDelete: {
    ...
    responses: { 200: userBulkResultResponseSchema, 400: errorResponse, 403: errorResponse, 404: errorResponse, 409: errorResponse, 500: errorResponse },
  ...
  delete: {
    ...
    responses: { 200: z.object({ success: z.literal(true) }), 400: errorResponse, 403: errorResponse, 404: errorResponse, 409: errorResponse, 500: errorResponse },
