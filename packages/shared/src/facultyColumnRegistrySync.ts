...
import { teacherWorkColumnLabelsFrom } from './facultyDirectoryColumns.js';
import { syncModuleColumnRegistryWithFields } from './moduleColumnRegistrySync.js';
import { listEnabledCustomTeacherFormFields } from './facultyFormCustomFields.js';
...
export const syncFacultyColumnRegistryWithFields = syncTeacherColumnRegistryWithFields;
export const defaultFacultyWorkColumnRegistry = defaultTeacherWorkColumnRegistry;
export const FACULTY_WORK_COLUMN_PLACEHOLDER_LABELS = TEACHER_WORK_COLUMN_PLACEHOLDER_LABELS;
