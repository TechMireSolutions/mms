...
export const defaultFacultyEnabledTabIds = defaultTeacherEnabledTabIds;
export const resolveFacultyEnabledTabIds = resolveTeacherEnabledTabIds;
export type FacultyEnabledTabsInput = TeacherEnabledTabsInput;
