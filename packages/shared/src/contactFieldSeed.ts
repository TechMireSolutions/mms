...
export const INITIAL_FIELD_SEED: Record<string, FieldDefinition[]> = {
  basic: [
    ...
    { key: "gender",         label: "Gender (Male / Female)", labelKey: "contacts.fields.gender",         type: "select",  description: "Gender selector. Enables personalization & inclusive communication.", descriptionKey: "contacts.fields.genderDesc", options: GENDERS, defaultValue: "", permissions: [], enabled: true, order: 4, required: true },
    ...
    { key: "tag",            label: "Tag",                    labelKey: "contacts.fields.tag",            type: "tags",    description: "Contact category or classification tag.", descriptionKey: "contacts.fields.tagDesc", options: DEFAULT_TAG_LABELS, defaultValue: "", permissions: [], enabled: true, order: 7, required: false },
  ],
  phones: [
