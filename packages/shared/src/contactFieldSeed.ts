...
export const INITIAL_FIELD_SEED: Record<string, FieldDefinition[]> = {
  basic: [
    ...
    { key: "cnic",           label: "CNIC / National ID",     labelKey: "contacts.form.cnic",             type: "text",    description: "National identity number when required by the madrasa.", descriptionKey: "contacts.fields.cnicDesc", defaultValue: "", permissions: [], enabled: true, order: 6, required: false },
  ],
  phones: [
