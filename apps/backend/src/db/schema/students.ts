...
export type StudentUserColumnPrefsRow = typeof studentUserColumnPrefs.$inferSelect;
export type InsertStudentUserColumnPrefsRow = typeof studentUserColumnPrefs.$inferInsert;
