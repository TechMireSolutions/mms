...
export const loadAttendanceRecordById = attendanceUseCases.loadAttendanceRecordById;
export const loadAttendanceRecordsByIds = attendanceUseCases.loadAttendanceRecordsByIds;
