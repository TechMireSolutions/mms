...
export const DASHBOARD_WIDGET_REGISTRY: Record<string, DashboardWidgetRegistryEntry> = {
  ...
  'def-card-admin-classes': { titleKey: 'widget.title.activeClasses', subTextKey: 'widget.subtitle.allActiveClasses', trendMetric: 'sessions' },
  ...
  'def-card-teacher-classes': { titleKey: 'widget.title.myClasses', subTextKey: 'widget.subtitle.activeClassesCount', trendMetric: 'sessions' },
  ...
  'def-card-accountant-revenue': { titleKey: 'widget.title.totalRevenueYtd', subTextKey: 'widget.subtitle.fromInvoices', trendMetric: 'fees' },
  'def-card-accountant-expenses': { titleKey: 'widget.title.totalExpensesYtd', subTextKey: 'widget.subtitle.totalDiscountOffset', trendMetric: 'fees' },
