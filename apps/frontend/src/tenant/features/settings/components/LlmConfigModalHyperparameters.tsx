    ...
    <div className="space-y-4 border-t border-border pt-4">
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <Slider id="temperature" name="temperature" min={0.0} max={2.0} step={0.1} value={[formTemperature]} onValueChange={(val) => setFormTemperature(val[0] ?? 0.7)} />
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <Slider id="topP" name="topP" min={0.0} max={1.0} step={0.05} value={[formTopP]} onValueChange={(val) => setFormTopP(val[0] ?? 1.0)} />
