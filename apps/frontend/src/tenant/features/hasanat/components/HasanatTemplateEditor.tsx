...
export const DEFAULT_HASANAT_TEMPLATE: DocumentTemplate<HasanatPayload> = {
  ...
  elements: [
    ...
    { id: "h_title", type: "static", label: "سند صرف حسنات | Hasanat Award Voucher", x: 20, y: 40, w: 340, h: 18, style: { fontSize: 10, textAlign: "center", color: "#059669" } },
    { id: "h_div1", type: "divider", label: "", x: 20, y: 62, w: 519, h: 1, style: { color: "#10b981" } },
    ...
    { id: "h_pts", type: "field", field: "totalPoints", label: "50 Hasanat", x: 320, y: 84, w: 219, h: 32, style: { fontSize: 16, fontWeight: "bold", color: "#047857", textAlign: "center" } },
    { id: "h_qr", type: "qrcode", label: "QR Verify", x: 20, y: 130, w: 54, h: 54 },
    { id: "h_by", type: "field", field: "issuedBy", label: "المسؤول: Admin Office", x: 320, y: 160, w: 219, h: 16, style: { fontSize: 9, textAlign: "right", color: "#64748b" } },
  ],
};
