...
type DistributionManagerListDesktopTableProps = DistributionManagerListProps;

export function DistributionManagerListDesktopTable(props: DistributionManagerListDesktopTableProps): React.JSX.Element {
  const {
    distributions,
    denoms,
    selectedIds,
