...
import type { AggregateCardValue, KPIItem, KPISummaryProps } from './kpiSummaryTypes';
  ...
  return (
    <div className="w-full space-y-3">
      <KPISummarySettings
        ...
        editingCardConfig={editingCardConfig}
      ...
      />
      <KPICardsGrid cards={visibleCards} onAddCustom={openCustomCardBuilder} />
    </div>
  );
}
