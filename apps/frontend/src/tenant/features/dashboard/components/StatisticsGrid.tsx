      ...
      {statItems.map((statItem, statIndex) => {
        ...
        return (
          ...
          >
            ...
            <div className={`absolute inset-inline-start-0 top-0 bottom-0 w-[3.5px] rounded-r-[2px] ${ACCENT_BAR_MAP[statItem.color] || "bg-success"}/60 group-hover:${ACCENT_BAR_MAP[statItem.color] || "bg-success"} transition-colors duration-300`} />
