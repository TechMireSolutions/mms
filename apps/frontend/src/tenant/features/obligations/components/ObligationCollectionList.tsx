...
import { ObligationCollectionListContent, type ObligationCollectionVisibleColumns } from "@/tenant/features/obligations/components/ObligationCollectionListContent";
...
export function ObligationCollectionList({
  ...
  const visibleColumns: ObligationCollectionVisibleColumns = {
    receiptNo: isColumnVisible ? isColumnVisible("receiptNo") : true,
    receivedDate: isColumnVisible ? isColumnVisible("receivedDate") : true,
    sender: isColumnVisible ? isColumnVisible("sender") : true,
    obligationType: isColumnVisible ? isColumnVisible("obligationType") : true,
    repMujtahid: isColumnVisible ? isColumnVisible("repMujtahid") : true,
    amount: isColumnVisible ? isColumnVisible("amount") : true,
    paymentMode: isColumnVisible ? isColumnVisible("paymentMode") : true,
  };
