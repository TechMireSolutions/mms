 ...
 */
export function PaperBuilder({ questions, tests, onSaveTest }: PaperBuilderProps): React.ReactElement {
  ...
  return (
    <article className="space-y-5" aria-labelledby="paper-generator-title">
