...
import { useFacultyEntityDescriptor } from "./useFacultyEntityDescriptor";
...
function renderHookWrapper() {
  ...
  function TestComponent() {
    hookResult = useFacultyEntityDescriptor();
    return null;
  }
...
describe("useFacultyEntityDescriptor", () => {
  it("returns a descriptor with i18n-resolved labels for all fields", () => {
    ...
    expect(descriptor.entityType).toBe("faculty");
    expect(descriptor.singularLabel).toBe("Faculty Member");
