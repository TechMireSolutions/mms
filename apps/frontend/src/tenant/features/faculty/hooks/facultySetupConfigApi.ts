...
export const setFacultyPreferencesMemory = setTeacherPreferencesMemory;
export const fetchFacultyPreferences = fetchTeacherPreferences;
export const saveFacultyPreferencesAsync = saveTeacherPreferencesAsync;
export const getFacultySettingsMemoryFallback = getTeacherSettingsMemoryFallback;
