...
import { useTeacherPreferencesMutation } from "@/tenant/features/faculty/hooks/useFacultySetupConfig";
import { useTeacherMutations } from "@/tenant/features/faculty/hooks/useFaculty";
