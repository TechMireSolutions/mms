...
export interface MessagingWorkCardsProps {
  logs: Message[];
...
export const MessagingWorkCards = React.memo(function MessagingWorkCards({
  logs,
  selectedIds,
  allVisibleSelected,
  someVisibleSelected,
  ...
  onViewLog,
  onFilterContact,
}: MessagingWorkCardsProps): React.JSX.Element {
