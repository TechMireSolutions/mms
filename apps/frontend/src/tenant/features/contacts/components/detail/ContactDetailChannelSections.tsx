/** Stable barrel for contact detail channel collection sections. */
export { ContactDetailPhonesSection } from "./ContactDetailPhonesSection";
...
export { ContactDetailBankDetailsSection } from "./ContactDetailBankDetailsSection";
