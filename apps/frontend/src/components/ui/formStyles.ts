...
export const FORM_INPUT =
  'w-full rounded-lg border border-border bg-background px-3 py-2.5 min-h-[44px] text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/20 focus-visible:border-primary/40 touch-manipulation';
...
export const FORM_INPUT_COMPACT =
  'w-full rounded-lg border border-border bg-background px-2 py-2 min-h-[44px] text-xs text-foreground placeholder:text-muted-foreground focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/20 focus-visible:border-primary/40 touch-manipulation';
...
export const FORM_OTP_DIGIT =
  'w-11 min-h-[44px] h-12 text-center text-xl font-bold rounded-xl border-2 bg-card text-foreground focus:outline-none focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-primary/20 touch-manipulation';
...
export const WORK_TOOLBAR_TRIGGER =
  'flex items-center gap-1.5 px-3 min-h-[44px] rounded-xl border text-sm font-medium transition-colors hover:bg-muted touch-manipulation';
...
export const FORM_SELECT_MINI =
  'min-h-[44px] h-11 px-3 py-2 rounded text-xs font-bold bg-card border border-border text-foreground focus:outline-none cursor-pointer w-auto gap-1 shadow-none touch-manipulation';
