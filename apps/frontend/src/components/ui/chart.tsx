  ...
  return (
    (<ChartContext.Provider value={{ config }}>
      <div
        ...
        <RechartsPrimitive.ResponsiveContainer width="100%" height="100%" minWidth={0} initialDimension={{ width: 1, height: 1 }}>
          {children}
...
export interface ChartTooltipContentProps extends React.ComponentProps<"div"> {
  ...
  formatter?: (
    ...
    index: number,
    payload: NonNullable<ChartTooltipContentProps["payload"]>[number]["payload"]
  ) => React.ReactNode
  color?: string
}
