  ...
  return (
    <Popover open={open} onOpenChange={handleOpenChange}>
      ...
      <PopoverContent
        ...
        sideOffset={6}
        collisionPadding={8}
        className="p-0 w-[var(--radix-popover-trigger-width)] min-w-popover-lg max-h-[var(--radix-popover-content-available-height)] flex flex-col overflow-hidden rounded-xl surface-overlay divide-y divide-border/60"
        onKeyDown={(event) => {
