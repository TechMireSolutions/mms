...
**Rules (norms SSOT):** `mms-testing-observability.mdc` · `mms-agent-universal.mdc` · `mms-completion-review.mdc` · `mms-ui-ux-design.mdc` §3–§4 · `mms-performance.mdc` §6. Accessibility smoke specifics → **`mms-a11y-smoke`**.
