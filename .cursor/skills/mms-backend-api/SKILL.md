...
**Rules (norms SSOT):** `mms-api-interface.mdc` · `mms-data-layer.mdc` §5–§6 · `mms-auth-security.mdc`. Checklists → `references/new-route-checklist.md` · `references/add-rest-resource.md`.
