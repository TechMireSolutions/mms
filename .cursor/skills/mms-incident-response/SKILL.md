...
**Rules (norms SSOT):** `mms-ops-infrastructure.mdc` (ports 5002/3000, health endpoints, PM2/Apache topology, CI deploy flow) · `mms-agent-universal.mdc` (say "commit" / "push" explicitly).
