...
- [ ] Mandatory virtualization: `@tanstack/react-virtual` for tables/lists/cards > 30 items (`mms-performance.mdc`); card rows `< md` and/or `overflow-x-auto` tables; touch ≥ 44px (`mms-ui-ux-design.mdc` §4)
