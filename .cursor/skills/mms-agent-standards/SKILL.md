...
**Rules (norms SSOT):** `mms-agent-universal.mdc` (enforcement principle, tool neutrality) · `mms-core.mdc` (ownership matrix) · `.cursor/rules/README.md` (topic → owner rule → skill).
