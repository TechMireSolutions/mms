...
Residual Work SQL-page debt for **other** modules (not Faculty/Users/Sessions) lives under “SQL pagination / oversized shells” in `mms-migration-status.mdc`.
