...
**Rules (norms SSOT):** `mms-data-layer.mdc` · `mms-performance.mdc` §1 · `mms-ops-infrastructure.mdc` · `mms-structure-naming.mdc` · `mms-api-interface.mdc` · `mms-form-architecture.mdc`.
