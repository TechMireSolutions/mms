...
- [ ] Contact collection deletes persist (`[]` + scalar sync; no existing-row / scalar resurrection) — `mms-form-architecture.mdc` §3
...
- Frontend: `mms-api-interface.mdc`, `mms-data-layer.mdc`, `mms-hooks.mdc`, `mms-ui-ux-design.mdc`, `mms-auth-security.mdc`, `mms-messaging.mdc`
