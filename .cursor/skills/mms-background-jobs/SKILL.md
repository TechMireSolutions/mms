...
description: Implements or reviews MMS background jobs and queued processing from mms-module-architecture.mdc §5: large exports, imports, bulk operations, dedup scans, progress UI, download artifacts, tenant/user scoping, RBAC, and audit.
---

# MMS Background Jobs Workflow

Source: `mms-module-architecture.mdc` §5. Rules: `mms-module-architecture.mdc`, `mms-auth-security.mdc`.
