...
Source: `mms-module-architecture.mdc` §5. Rules: `mms-module-architecture.mdc`, `mms-auth-security.mdc`, `mms-performance.mdc` §2 (Zero Memory Buffering & Streaming Background Workers).
