...
1. **Soft-Delete / Deactivation:** Prefer deactivating or hiding fields/tabs in the blueprint configuration instead of erasing schema definitions (to preserve historical analytics data), as detailed in [mms-form-architecture.md](../rules/mms-form-architecture.md).
