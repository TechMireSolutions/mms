...
Entity forms are static `FormModal` + shared Zod (no blueprint compilers). Custom `custom_data` / GIN / SET LOCAL / `COALESCE ||` merge rules still follow **`mms-form-architecture.md`** and **`mms-data-layer.md`**:
