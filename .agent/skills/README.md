...
| [mms-module-page](mms-module-page/SKILL.md) | New module or three-tier page — `mms-module-architecture.md` |
| [mms-module-work](mms-module-work/SKILL.md) | Command centre and Work tier — metrics, directory, drawer, bulk actions (`mms-module-architecture.md` §2–§3) |
